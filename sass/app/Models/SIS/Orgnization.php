...
class Orgnization extends Model
{
    ...
    protected $fillable = ['name', 'description', 'parent_id', 'level', 'sort', 'code', 'current_login_orgnization', 'sub_title', 'ancestor_id', 'longitude', 'latitude', 'address', 'status', 'electricity_ability'];
