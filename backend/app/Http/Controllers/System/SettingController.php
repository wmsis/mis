...
class SettingController extends Controller
{
     ...
     *     summary="分页获取系统用户映射关系列表",
     *     description="使用说明：分页获取系统用户映射关系列表",
     *     @OA\Parameter(
     *         description="token",
     *         in="query",
     *         name="token",
