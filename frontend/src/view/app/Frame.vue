                ...
                for (let menu of this.menus) {
                    ...
                    for (let child of children) {
                        ...
                        if (!child.relations) {
                            ...
                            if(typeof child.relations != 'object') {
                                child.relations = JSON.parse(child.relations);
                            }

                            for (let relation of child.relations) {
                                if (targetRouteName == relation.target) {
                                    this.openNames = [menu.id];
                                    this.activeName = child.target;
