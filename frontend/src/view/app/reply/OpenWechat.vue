<template>
    <div class="diy-page">
        <div class="diy-content">
            ...
            <div class="link" v-if="formData.type=='text'">
                <p>可填入文本信息</p>
            ...
            <div class="text" v-if="formData.type=='text'">
                <div class="title" style="width: 70px; height: 32px; line-height: 32px; font-weight: bold;">文本</div>
                <div class="textarea">
            ...
            <div class="variable">
                <p>间隔分钟数说明：</p>
                <p>出于对用户的友好体验，建议一段时间内只触发该功能一次（建议60分钟）</p>
            </div>
            <div class="demo">
                <div class="text">
                    <div class="title">间隔分钟数</div>
                    <div class="textarea">
                        <Input v-model="formData.interval_time"  placeholder="请输入间隔分钟数"  />
                    </div>
                </div>
            </div>
        </div>
        <div class="toolbar">
            <Button type="primary" icon="md-checkmark-circle-outline" @click="handleSubmit" v-if="isButtonExist('openwechat-save')">提交</Button>
        </div>
            ...
            handleSubmit: function () {
                ...
                vm.ajax({
                    ...
                    data: {
                        ...
                        interval_time: vm.formData.interval_time
                    },
                    success: function () {
