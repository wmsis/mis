    ...
    <div class="diy-page">
        <div class="diy-content">
            ...
            <div class="demo">
                ...
                <div class="pic" v-if="formData.type=='pic_txt'">
        ...
        <div class="toolbar">
            <Button type="primary" icon="md-checkmark-circle-outline" @click="handleSubmit" v-if="isButtonExist('subscribe-save')">提交</Button>
        </div>
