<template>
    <Modal
        ...
        <Form ref="formRef"
              ...
              :label-width="100"
              label-position="left">
            <div class="container-keyword-reply-update">
                    ...
                    <Col span="24" >
                        <FormItem prop="img" label="图片">
                            <image-upload ref="imgUploadRef"
                                          ...
                                          v-bind:initialData="formData.img"
    ...
    export default {
        ...
        methods: {
            visibleChange: function (visible) {
                if (visible) {
                    this.formData.id = this.keywordReply.id;
                    this.formData.keyword = this.keywordReply.keyword;
                    this.formData.type = this.keywordReply.type;
                    this.formData.category = this.keywordReply.category;
                    this.formData.text = this.keywordReply.text;
                    this.formData.pic_txt_id = this.keywordReply.pic_txt_id;
                    this.formData.img = this.keywordReply.img;
                    this.loadPicTxtList();
                } else {
...
<style lang="scss">
    .container-keyword-reply-update {
        .tips {
            padding: 5px 20px;
