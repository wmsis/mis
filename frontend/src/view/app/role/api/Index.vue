        ...
        <div class="center">
            ...
            <div class="button-bar">
                <ButtonGroup :style="{'margin': '0px 0px 10px 0px'}">
                    <Button
                            v-if="showAddSubButton && isButtonExist('api-insert')"
                            type="primary"
                            icon="md-add-circle"
                            @click="shows.add = true">{{currentNode ? '新增子节点' : '新增父节点'}}</Button>
                    <Button
                        v-if="showModifyButton && isButtonExist('api-update')"
                        type="primary"
                        icon="ios-create"
                        @click="shows.update = true">修改</Button>
                    <Button
                        v-if="showDeleteButton && isButtonExist('api-delete')"
                        type="primary"
