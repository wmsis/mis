<template>
    <Modal
        ...
        <Form ref="formRef"
              ...
              :label-width="60"
              label-position="left">
            <div class="container-material-update">
    ...
    export default {
        ...
        methods: {
            visibleChange: function (visible) {
                if (visible) {
                    this.formData.id = this.material.id;
                    this.formData.img = this.material.img;
                    this.formData.title = this.material.title;
                    this.formData.description = this.material.description;
                    this.formData.url = this.material.url;
                    this.formData.sort = this.material.sort;
                    this.formData.type = this.material.type;
                    this.formData.pic_txt_id = this.material.pic_txt_id;
                    this.$refs.imgUploadRef.init(this.formData.img);
                } else {
